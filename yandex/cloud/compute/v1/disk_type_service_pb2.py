...
_GETDISKTYPEREQUEST = DESCRIPTOR.message_types_by_name['GetDiskTypeRequest']
_LISTDISKTYPESREQUEST = DESCRIPTOR.message_types_by_name['ListDiskTypesRequest']
_LISTDISKTYPESRESPONSE = DESCRIPTOR.message_types_by_name['ListDiskTypesResponse']
...
_DISKTYPESERVICE = DESCRIPTOR.services_by_name['DiskTypeService']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETDISKTYPEREQUEST.fields_by_name['disk_type_id']._serialized_options = b'\350\3071\001'
  _LISTDISKTYPESREQUEST.fields_by_name['page_size']._options = None
  _LISTDISKTYPESREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\006<=1000'
  _LISTDISKTYPESREQUEST.fields_by_name['page_token']._options = None
  _LISTDISKTYPESREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _DISKTYPESERVICE.methods_by_name['Get']._options = None
  _DISKTYPESERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002&\022$/compute/v1/diskTypes/{disk_type_id}'
  _DISKTYPESERVICE.methods_by_name['List']._options = None
  _DISKTYPESERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002\027\022\025/compute/v1/diskTypes'
  _GETDISKTYPEREQUEST._serialized_start=178
  _GETDISKTYPEREQUEST._serialized_end=226
  _LISTDISKTYPESREQUEST._serialized_start=228
  _LISTDISKTYPESREQUEST._serialized_end=312
  _LISTDISKTYPESRESPONSE._serialized_start=314
  _LISTDISKTYPESRESPONSE._serialized_end=417
  _DISKTYPESERVICE._serialized_start=420
  _DISKTYPESERVICE._serialized_end=706
