...
_SCANMETADATA = DESCRIPTOR.message_types_by_name['ScanMetadata']
_GETSCANRESULTREQUEST = DESCRIPTOR.message_types_by_name['GetScanResultRequest']
_GETLASTSCANRESULTREQUEST = DESCRIPTOR.message_types_by_name['GetLastScanResultRequest']
_LISTSCANRESULTSREQUEST = DESCRIPTOR.message_types_by_name['ListScanResultsRequest']
_LISTSCANRESULTSRESPONSE = DESCRIPTOR.message_types_by_name['ListScanResultsResponse']
_LISTVULNERABILITIESREQUEST = DESCRIPTOR.message_types_by_name['ListVulnerabilitiesRequest']
_LISTVULNERABILITIESRESPONSE = DESCRIPTOR.message_types_by_name['ListVulnerabilitiesResponse']
...
_SCANNERSERVICE = DESCRIPTOR.services_by_name['ScannerService']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SCANREQUEST.fields_by_name['image_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _GETSCANRESULTREQUEST.fields_by_name['scan_result_id']._options = None
  _GETSCANRESULTREQUEST.fields_by_name['scan_result_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _GETLASTSCANRESULTREQUEST.fields_by_name['image_id']._options = None
  _GETLASTSCANRESULTREQUEST.fields_by_name['image_id']._serialized_options = b'\212\3101\004<=50'
  _LISTSCANRESULTSREQUEST.oneofs_by_name['id']._options = None
  _LISTSCANRESULTSREQUEST.oneofs_by_name['id']._serialized_options = b'\300\3011\001'
  _LISTSCANRESULTSREQUEST.fields_by_name['image_id']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['image_id']._serialized_options = b'\212\3101\004<=50'
  _LISTSCANRESULTSREQUEST.fields_by_name['repository_id']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['repository_id']._serialized_options = b'\212\3101\004<=50'
  _LISTSCANRESULTSREQUEST.fields_by_name['page_size']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTSCANRESULTSREQUEST.fields_by_name['page_token']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _LISTSCANRESULTSREQUEST.fields_by_name['filter']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['filter']._serialized_options = b'\212\3101\006<=1000'
  _LISTSCANRESULTSREQUEST.fields_by_name['order_by']._options = None
  _LISTSCANRESULTSREQUEST.fields_by_name['order_by']._serialized_options = b'\212\3101\005<=100'
  _LISTVULNERABILITIESREQUEST.fields_by_name['scan_result_id']._options = None
  _LISTVULNERABILITIESREQUEST.fields_by_name['scan_result_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTVULNERABILITIESREQUEST.fields_by_name['page_size']._options = None
  _LISTVULNERABILITIESREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTVULNERABILITIESREQUEST.fields_by_name['page_token']._options = None
  _LISTVULNERABILITIESREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _LISTVULNERABILITIESREQUEST.fields_by_name['filter']._options = None
  _LISTVULNERABILITIESREQUEST.fields_by_name['filter']._serialized_options = b'\212\3101\006<=1000'
  _LISTVULNERABILITIESREQUEST.fields_by_name['order_by']._options = None
  _LISTVULNERABILITIESREQUEST.fields_by_name['order_by']._serialized_options = b'\212\3101\005<=100'
  _SCANNERSERVICE.methods_by_name['Scan']._options = None
  _SCANNERSERVICE.methods_by_name['Scan']._serialized_options = b'\202\323\344\223\002!\"\034/container-registry/v1/scans:\001*\262\322*\032\n\014ScanMetadata\022\nScanResult'
  _SCANNERSERVICE.methods_by_name['Get']._options = None
  _SCANNERSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002/\022-/container-registry/v1/scans/{scan_result_id}'
  _SCANNERSERVICE.methods_by_name['GetLast']._options = None
  _SCANNERSERVICE.methods_by_name['GetLast']._serialized_options = b'\202\323\344\223\0029\0227/container-registry/v1/images/{image_id}:lastScanResult'
  _SCANNERSERVICE.methods_by_name['List']._options = None
  _SCANNERSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002\036\022\034/container-registry/v1/scans'
  _SCANNERSERVICE.methods_by_name['ListVulnerabilities']._options = None
  _SCANNERSERVICE.methods_by_name['ListVulnerabilities']._serialized_options = b'\202\323\344\223\002C\022A/container-registry/v1/scans/{scan_result_id}:listVulnerabilities'
  _SCANREQUEST._serialized_start=278
  _SCANREQUEST._serialized_end=323
  _SCANMETADATA._serialized_start=325
  _SCANMETADATA._serialized_end=363
  _GETSCANRESULTREQUEST._serialized_start=365
  _GETSCANRESULTREQUEST._serialized_end=425
  _GETLASTSCANRESULTREQUEST._serialized_start=427
  _GETLASTSCANRESULTREQUEST._serialized_end=481
  _LISTSCANRESULTSREQUEST._serialized_start=484
  _LISTSCANRESULTSREQUEST._serialized_end=704
  _LISTSCANRESULTSRESPONSE._serialized_start=706
  _LISTSCANRESULTSRESPONSE._serialized_end=825
  _LISTVULNERABILITIESREQUEST._serialized_start=828
  _LISTVULNERABILITIESREQUEST._serialized_end=1013
  _LISTVULNERABILITIESRESPONSE._serialized_start=1016
  _LISTVULNERABILITIESRESPONSE._serialized_end=1145
  _SCANNERSERVICE._serialized_start=1148
  _SCANNERSERVICE._serialized_end=2071
