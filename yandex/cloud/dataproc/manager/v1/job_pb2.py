...
_APPLICATIONATTEMPT = DESCRIPTOR.message_types_by_name['ApplicationAttempt']
_APPLICATIONINFO = DESCRIPTOR.message_types_by_name['ApplicationInfo']
_MAPREDUCEJOB = DESCRIPTOR.message_types_by_name['MapreduceJob']
_MAPREDUCEJOB_PROPERTIESENTRY = _MAPREDUCEJOB.nested_types_by_name['PropertiesEntry']
...
MapreduceJob = _reflection.GeneratedProtocolMessageType('MapreduceJob', (_message.Message,), {
  ...
  'PropertiesEntry' : _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {
    ...
    '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
    # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.MapreduceJob.PropertiesEntry)
    })
  ,
...
SparkJob = _reflection.GeneratedProtocolMessageType('SparkJob', (_message.Message,), {
  ...
  'PropertiesEntry' : _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {
    ...
    '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
    # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.SparkJob.PropertiesEntry)
    })
  ,
...
PysparkJob = _reflection.GeneratedProtocolMessageType('PysparkJob', (_message.Message,), {
  ...
  'PropertiesEntry' : _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {
    ...
    '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
    # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.PysparkJob.PropertiesEntry)
    })
  ,
...
HiveJob = _reflection.GeneratedProtocolMessageType('HiveJob', (_message.Message,), {
  ...
  'PropertiesEntry' : _reflection.GeneratedProtocolMessageType('PropertiesEntry', (_message.Message,), {
    ...
    '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
    # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.HiveJob.PropertiesEntry)
    })
  ,
  ...
  'ScriptVariablesEntry' : _reflection.GeneratedProtocolMessageType('ScriptVariablesEntry', (_message.Message,), {
    ...
    '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
    # @@protoc_insertion_point(class_scope:yandex.cloud.dataproc.manager.v1.HiveJob.ScriptVariablesEntry)
    })
  ,
  'DESCRIPTOR' : _HIVEJOB,
  '__module__' : 'yandex.cloud.dataproc.manager.v1.job_pb2'
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _JOB._serialized_end=882
  _JOB_STATUS._serialized_start=742
  _JOB_STATUS._serialized_end=870
  _APPLICATIONATTEMPT._serialized_start=884
  _APPLICATIONATTEMPT._serialized_end=941
  _APPLICATIONINFO._serialized_start=943
  _APPLICATIONINFO._serialized_end=1056
  _MAPREDUCEJOB._serialized_start=1059
  _MAPREDUCEJOB._serialized_end=1347
  _MAPREDUCEJOB_PROPERTIESENTRY._serialized_start=1288
  _MAPREDUCEJOB_PROPERTIESENTRY._serialized_end=1337
  _SPARKJOB._serialized_start=1350
  _SPARKJOB._serialized_end=1682
  _SPARKJOB_PROPERTIESENTRY._serialized_start=1288
  _SPARKJOB_PROPERTIESENTRY._serialized_end=1337
  _PYSPARKJOB._serialized_start=1685
  _PYSPARKJOB._serialized_end=2030
  _PYSPARKJOB_PROPERTIESENTRY._serialized_start=1288
  _PYSPARKJOB_PROPERTIESENTRY._serialized_end=1337
  _QUERYLIST._serialized_start=2032
  _QUERYLIST._serialized_end=2060
  _HIVEJOB._serialized_start=2063
  _HIVEJOB._serialized_end=2507
  _HIVEJOB_PROPERTIESENTRY._serialized_start=1288
  _HIVEJOB_PROPERTIESENTRY._serialized_end=1337
  _HIVEJOB_SCRIPTVARIABLESENTRY._serialized_start=2439
  _HIVEJOB_SCRIPTVARIABLESENTRY._serialized_end=2493
