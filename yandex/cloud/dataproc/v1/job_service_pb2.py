...
_CREATEJOBMETADATA = DESCRIPTOR.message_types_by_name['CreateJobMetadata']
_CANCELJOBREQUEST = DESCRIPTOR.message_types_by_name['CancelJobRequest']
_LISTJOBLOGREQUEST = DESCRIPTOR.message_types_by_name['ListJobLogRequest']
_LISTJOBLOGRESPONSE = DESCRIPTOR.message_types_by_name['ListJobLogResponse']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETJOBREQUEST.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _GETJOBREQUEST.fields_by_name['job_id']._options = None
  _GETJOBREQUEST.fields_by_name['job_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTJOBSREQUEST.fields_by_name['cluster_id']._options = None
  _LISTJOBSREQUEST.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  ...
  _CREATEJOBREQUEST.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATEJOBREQUEST.fields_by_name['name']._options = None
  _CREATEJOBREQUEST.fields_by_name['name']._serialized_options = b'\362\3071\035|[a-z][-a-z0-9]{1,61}[a-z0-9]'
  _CREATEJOBMETADATA.fields_by_name['cluster_id']._options = None
  _CREATEJOBMETADATA.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CREATEJOBMETADATA.fields_by_name['job_id']._options = None
  _CREATEJOBMETADATA.fields_by_name['job_id']._serialized_options = b'\212\3101\004<=50'
  _CANCELJOBREQUEST.fields_by_name['cluster_id']._options = None
  _CANCELJOBREQUEST.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _CANCELJOBREQUEST.fields_by_name['job_id']._options = None
  _CANCELJOBREQUEST.fields_by_name['job_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTJOBLOGREQUEST.fields_by_name['cluster_id']._options = None
  _LISTJOBLOGREQUEST.fields_by_name['cluster_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTJOBLOGREQUEST.fields_by_name['job_id']._options = None
  _LISTJOBLOGREQUEST.fields_by_name['job_id']._serialized_options = b'\212\3101\004<=50'
  _LISTJOBLOGREQUEST.fields_by_name['page_size']._options = None
  _LISTJOBLOGREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\t<=1048576'
  _LISTJOBLOGREQUEST.fields_by_name['page_token']._options = None
  _LISTJOBLOGREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _JOBSERVICE.methods_by_name['List']._options = None
  _JOBSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002)\022\'/dataproc/v1/clusters/{cluster_id}/jobs'
  _JOBSERVICE.methods_by_name['Create']._options = None
  _JOBSERVICE.methods_by_name['Create']._serialized_options = b'\202\323\344\223\002,\"\'/dataproc/v1/clusters/{cluster_id}/jobs:\001*\262\322*\030\n\021CreateJobMetadata\022\003Job'
  _JOBSERVICE.methods_by_name['Get']._options = None
  _JOBSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\0022\0220/dataproc/v1/clusters/{cluster_id}/jobs/{job_id}'
  _JOBSERVICE.methods_by_name['ListLog']._options = None
  _JOBSERVICE.methods_by_name['ListLog']._serialized_options = b'\202\323\344\223\0027\0225/dataproc/v1/clusters/{cluster_id}/jobs/{job_id}:logs'
  _JOBSERVICE.methods_by_name['Cancel']._options = None
  _JOBSERVICE.methods_by_name['Cancel']._serialized_options = b'\202\323\344\223\002<\"7/dataproc/v1/clusters/{cluster_id}/jobs/{job_id}:cancel:\001*\262\322*\030\n\021CreateJobMetadata\022\003Job'
  _GETJOBREQUEST._serialized_start=243
  _GETJOBREQUEST._serialized_end=322
  _LISTJOBSREQUEST._serialized_start=325
  _LISTJOBSREQUEST._serialized_end=466
  _LISTJOBSRESPONSE._serialized_start=468
  _LISTJOBSRESPONSE._serialized_end=556
  _CREATEJOBREQUEST._serialized_start=559
  _CREATEJOBREQUEST._serialized_end=910
  _CREATEJOBMETADATA._serialized_start=912
  _CREATEJOBMETADATA._serialized_end=991
  _CANCELJOBREQUEST._serialized_start=993
  _CANCELJOBREQUEST._serialized_end=1075
  _LISTJOBLOGREQUEST._serialized_start=1078
  _LISTJOBLOGREQUEST._serialized_end=1222
  _LISTJOBLOGRESPONSE._serialized_start=1224
  _LISTJOBLOGRESPONSE._serialized_end=1286
  _JOBSERVICE._serialized_start=1289
  _JOBSERVICE._serialized_end=2106
