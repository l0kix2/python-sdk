...
_PUBLISHDEVICEDATAREQUEST = DESCRIPTOR.message_types_by_name['PublishDeviceDataRequest']
_PUBLISHDEVICEDATARESPONSE = DESCRIPTOR.message_types_by_name['PublishDeviceDataResponse']
...
_DEVICEDATASERVICE = DESCRIPTOR.services_by_name['DeviceDataService']
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _PUBLISHDEVICEDATAREQUEST.fields_by_name['device_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _PUBLISHDEVICEDATAREQUEST.fields_by_name['topic']._options = None
  _PUBLISHDEVICEDATAREQUEST.fields_by_name['topic']._serialized_options = b'\350\3071\001\212\3101\006<=1024'
  _PUBLISHDEVICEDATAREQUEST.fields_by_name['data']._options = None
  _PUBLISHDEVICEDATAREQUEST.fields_by_name['data']._serialized_options = b'\212\3101\010<=262144'
  _DEVICEDATASERVICE.methods_by_name['Publish']._options = None
  _DEVICEDATASERVICE.methods_by_name['Publish']._serialized_options = b'\202\323\344\223\0020\"+/iot-devices/v1/devices/{device_id}/publish:\001*'
  _PUBLISHDEVICEDATAREQUEST._serialized_start=147
  _PUBLISHDEVICEDATAREQUEST._serialized_end=265
  _PUBLISHDEVICEDATARESPONSE._serialized_start=267
  _PUBLISHDEVICEDATARESPONSE._serialized_end=294
  _DEVICEDATASERVICE._serialized_start=297
  _DEVICEDATASERVICE._serialized_end=495
