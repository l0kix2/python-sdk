...
_HEALTHCHECK_TCPOPTIONS = _HEALTHCHECK.nested_types_by_name['TcpOptions']
_HEALTHCHECK_HTTPOPTIONS = _HEALTHCHECK.nested_types_by_name['HttpOptions']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _HEALTHCHECK_TCPOPTIONS.fields_by_name['port']._serialized_options = b'\372\3071\0071-65535'
  _HEALTHCHECK_HTTPOPTIONS.fields_by_name['port']._options = None
  _HEALTHCHECK_HTTPOPTIONS.fields_by_name['port']._serialized_options = b'\372\3071\0071-65535'
  _HEALTHCHECK.oneofs_by_name['options']._options = None
  _HEALTHCHECK.oneofs_by_name['options']._serialized_options = b'\300\3011\001'
  _HEALTHCHECK.fields_by_name['name']._options = None
  _HEALTHCHECK.fields_by_name['name']._serialized_options = b'\350\3071\001\362\3071\035|[a-z][-a-z0-9]{1,61}[a-z0-9]'
  _HEALTHCHECK.fields_by_name['unhealthy_threshold']._options = None
  _HEALTHCHECK.fields_by_name['unhealthy_threshold']._serialized_options = b'\372\3071\0042-10'
  _HEALTHCHECK.fields_by_name['healthy_threshold']._options = None
  _HEALTHCHECK.fields_by_name['healthy_threshold']._serialized_options = b'\372\3071\0042-10'
  _HEALTHCHECK._serialized_start=145
  _HEALTHCHECK._serialized_end=646
  _HEALTHCHECK_TCPOPTIONS._serialized_start=534
  _HEALTHCHECK_TCPOPTIONS._serialized_end=573
  _HEALTHCHECK_HTTPOPTIONS._serialized_start=575
  _HEALTHCHECK_HTTPOPTIONS._serialized_end=629
