...
_AUTHPROVIDERS = DESCRIPTOR.message_types_by_name['AuthProviders']
_AUTHPROVIDER = DESCRIPTOR.message_types_by_name['AuthProvider']
_SAMLSETTINGS = DESCRIPTOR.message_types_by_name['SamlSettings']
_AUTHPROVIDER_TYPE = _AUTHPROVIDER.enum_types_by_name['Type']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _AUTHPROVIDER.fields_by_name['name']._serialized_options = b'\212\3101\004<=50\362\3071\020[a-z][a-z0-9_-]*'
  _AUTHPROVIDER.fields_by_name['description']._options = None
  _AUTHPROVIDER.fields_by_name['description']._serialized_options = b'\212\3101\004<=50'
  _AUTHPROVIDER.fields_by_name['hint']._options = None
  _AUTHPROVIDER.fields_by_name['hint']._serialized_options = b'\212\3101\005<=250'
  _AUTHPROVIDER.fields_by_name['icon']._options = None
  _AUTHPROVIDER.fields_by_name['icon']._serialized_options = b'\212\3101\005<=250'
  ...
  _SAMLSETTINGS.fields_by_name['kibana_url']._serialized_options = b'\212\3101\005<=250'
  _SAMLSETTINGS.fields_by_name['attribute_principal']._options = None
  _SAMLSETTINGS.fields_by_name['attribute_principal']._serialized_options = b'\212\3101\004<=50'
  _SAMLSETTINGS.fields_by_name['attribute_groups']._options = None
  _SAMLSETTINGS.fields_by_name['attribute_groups']._serialized_options = b'\212\3101\004<=50'
  _SAMLSETTINGS.fields_by_name['attribute_name']._options = None
  _SAMLSETTINGS.fields_by_name['attribute_name']._serialized_options = b'\212\3101\004<=50'
  _SAMLSETTINGS.fields_by_name['attribute_email']._options = None
  _SAMLSETTINGS.fields_by_name['attribute_email']._serialized_options = b'\212\3101\004<=50'
  _SAMLSETTINGS.fields_by_name['attribute_dn']._options = None
  _SAMLSETTINGS.fields_by_name['attribute_dn']._serialized_options = b'\212\3101\004<=50'
  _AUTHPROVIDERS._serialized_start=114
  _AUTHPROVIDERS._serialized_end=197
  _AUTHPROVIDER._serialized_start=200
  _AUTHPROVIDER._serialized_end=584
  _AUTHPROVIDER_TYPE._serialized_start=522
  _AUTHPROVIDER_TYPE._serialized_end=572
  _SAMLSETTINGS._serialized_start=587
  _SAMLSETTINGS._serialized_end=915
