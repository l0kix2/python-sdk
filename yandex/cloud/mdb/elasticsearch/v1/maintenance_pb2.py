...
MaintenanceWindow = _reflection.GeneratedProtocolMessageType('MaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.elasticsearch.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.elasticsearch.v1.MaintenanceWindow)
  })
...
AnytimeMaintenanceWindow = _reflection.GeneratedProtocolMessageType('AnytimeMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.elasticsearch.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.elasticsearch.v1.AnytimeMaintenanceWindow)
  })
...
WeeklyMaintenanceWindow = _reflection.GeneratedProtocolMessageType('WeeklyMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.elasticsearch.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.elasticsearch.v1.WeeklyMaintenanceWindow)
  })
...
MaintenanceOperation = _reflection.GeneratedProtocolMessageType('MaintenanceOperation', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.elasticsearch.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.elasticsearch.v1.MaintenanceOperation)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MAINTENANCEWINDOW._serialized_start=155
  _MAINTENANCEWINDOW._serialized_end=367
  _ANYTIMEMAINTENANCEWINDOW._serialized_start=369
  _ANYTIMEMAINTENANCEWINDOW._serialized_end=395
  _WEEKLYMAINTENANCEWINDOW._serialized_start=398
  _WEEKLYMAINTENANCEWINDOW._serialized_end=628
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_start=530
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_end=628
  _MAINTENANCEOPERATION._serialized_start=630
  _MAINTENANCEOPERATION._serialized_end=728
