...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _CREATECLUSTERREQUEST.fields_by_name['name']._serialized_options = b'\350\3071\001\212\3101\0041-63\362\3071\037[a-z]([-a-z0-9]{0,61}[a-z0-9])?'
  ...
  _CLUSTERSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002)\022\'/managed-kafka/v1/clusters/{cluster_id}'
  _CLUSTERSERVICE.methods_by_name['List']._options = None
  _CLUSTERSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002\034\022\032/managed-kafka/v1/clusters'
  _CLUSTERSERVICE.methods_by_name['Create']._options = None
  _CLUSTERSERVICE.methods_by_name['Create']._serialized_options = b'\202\323\344\223\002\037\"\032/managed-kafka/v1/clusters:\001*\262\322* \n\025CreateClusterMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['Update']._options = None
  _CLUSTERSERVICE.methods_by_name['Update']._serialized_options = b'\202\323\344\223\002,2\'/managed-kafka/v1/clusters/{cluster_id}:\001*\262\322* \n\025UpdateClusterMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['Delete']._options = None
  _CLUSTERSERVICE.methods_by_name['Delete']._serialized_options = b'\202\323\344\223\002)*\'/managed-kafka/v1/clusters/{cluster_id}\262\322*.\n\025DeleteClusterMetadata\022\025google.protobuf.Empty'
  _CLUSTERSERVICE.methods_by_name['Move']._options = None
  _CLUSTERSERVICE.methods_by_name['Move']._serialized_options = b'\202\323\344\223\0021\",/managed-kafka/v1/clusters/{cluster_id}:move:\001*\262\322*\036\n\023MoveClusterMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['Start']._options = None
  _CLUSTERSERVICE.methods_by_name['Start']._serialized_options = b'\202\323\344\223\002/\"-/managed-kafka/v1/clusters/{cluster_id}:start\262\322*\037\n\024StartClusterMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['Stop']._options = None
  _CLUSTERSERVICE.methods_by_name['Stop']._serialized_options = b'\202\323\344\223\002.\",/managed-kafka/v1/clusters/{cluster_id}:stop\262\322*\036\n\023StopClusterMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['RescheduleMaintenance']._options = None
  _CLUSTERSERVICE.methods_by_name['RescheduleMaintenance']._serialized_options = b'\202\323\344\223\002B\"=/managed-kafka/v1/clusters/{cluster_id}:rescheduleMaintenance:\001*\262\322*(\n\035RescheduleMaintenanceMetadata\022\007Cluster'
  _CLUSTERSERVICE.methods_by_name['ListLogs']._options = None
  _CLUSTERSERVICE.methods_by_name['ListLogs']._serialized_options = b'\202\323\344\223\002.\022,/managed-kafka/v1/clusters/{cluster_id}:logs'
  _CLUSTERSERVICE.methods_by_name['StreamLogs']._options = None
  _CLUSTERSERVICE.methods_by_name['StreamLogs']._serialized_options = b'\202\323\344\223\0025\0223/managed-kafka/v1/clusters/{cluster_id}:stream_logs'
  _CLUSTERSERVICE.methods_by_name['ListOperations']._options = None
  _CLUSTERSERVICE.methods_by_name['ListOperations']._serialized_options = b'\202\323\344\223\0024\0222/managed-kafka/v1/clusters/{cluster_id}/operations'
  _CLUSTERSERVICE.methods_by_name['ListHosts']._options = None
  _CLUSTERSERVICE.methods_by_name['ListHosts']._serialized_options = b'\202\323\344\223\002/\022-/managed-kafka/v1/clusters/{cluster_id}/hosts'
  _GETCLUSTERREQUEST._serialized_start=443
  _GETCLUSTERREQUEST._serialized_end=496
  _LISTCLUSTERSREQUEST._serialized_start=499
  _LISTCLUSTERSREQUEST._serialized_end=643
  _LISTCLUSTERSRESPONSE._serialized_start=645
  _LISTCLUSTERSRESPONSE._serialized_end=746
  _CREATECLUSTERREQUEST._serialized_start=749
  _CREATECLUSTERREQUEST._serialized_end=1546
  _CREATECLUSTERREQUEST_LABELSENTRY._serialized_start=1501
  _CREATECLUSTERREQUEST_LABELSENTRY._serialized_end=1546
  _CREATECLUSTERMETADATA._serialized_start=1548
  _CREATECLUSTERMETADATA._serialized_end=1591
  _UPDATECLUSTERREQUEST._serialized_start=1594
  _UPDATECLUSTERREQUEST._serialized_end=2154
  _UPDATECLUSTERREQUEST_LABELSENTRY._serialized_start=1501
  _UPDATECLUSTERREQUEST_LABELSENTRY._serialized_end=1546
  _UPDATECLUSTERMETADATA._serialized_start=2156
  _UPDATECLUSTERMETADATA._serialized_end=2199
  _DELETECLUSTERREQUEST._serialized_start=2201
  _DELETECLUSTERREQUEST._serialized_end=2257
  _DELETECLUSTERMETADATA._serialized_start=2259
  _DELETECLUSTERMETADATA._serialized_end=2302
  _LISTCLUSTERLOGSREQUEST._serialized_start=2305
  _LISTCLUSTERLOGSREQUEST._serialized_end=2600
  _LOGRECORD._serialized_start=2603
  _LOGRECORD._serialized_end=2777
  _LOGRECORD_MESSAGEENTRY._serialized_start=2731
  _LOGRECORD_MESSAGEENTRY._serialized_end=2777
  _LISTCLUSTERLOGSRESPONSE._serialized_start=2779
  _LISTCLUSTERLOGSRESPONSE._serialized_end=2881
  _STREAMLOGRECORD._serialized_start=2883
  _STREAMLOGRECORD._serialized_end=2981
  _STREAMCLUSTERLOGSREQUEST._serialized_start=2984
  _STREAMCLUSTERLOGSREQUEST._serialized_end=3220
  _LISTCLUSTEROPERATIONSREQUEST._serialized_start=3222
  _LISTCLUSTEROPERATIONSREQUEST._serialized_end=3348
  _LISTCLUSTEROPERATIONSRESPONSE._serialized_start=3350
  _LISTCLUSTEROPERATIONSRESPONSE._serialized_end=3461
  _LISTCLUSTERHOSTSREQUEST._serialized_start=3463
  _LISTCLUSTERHOSTSREQUEST._serialized_end=3584
  _LISTCLUSTERHOSTSRESPONSE._serialized_start=3586
  _LISTCLUSTERHOSTSRESPONSE._serialized_end=3685
  _MOVECLUSTERREQUEST._serialized_start=3687
  _MOVECLUSTERREQUEST._serialized_end=3786
  _MOVECLUSTERMETADATA._serialized_start=3788
  _MOVECLUSTERMETADATA._serialized_end=3886
  _STARTCLUSTERREQUEST._serialized_start=3888
  _STARTCLUSTERREQUEST._serialized_end=3943
  _STARTCLUSTERMETADATA._serialized_start=3945
  _STARTCLUSTERMETADATA._serialized_end=3987
  _STOPCLUSTERREQUEST._serialized_start=3989
  _STOPCLUSTERREQUEST._serialized_end=4043
  _STOPCLUSTERMETADATA._serialized_start=4045
  _STOPCLUSTERMETADATA._serialized_end=4086
  _RESCHEDULEMAINTENANCEREQUEST._serialized_start=4089
  _RESCHEDULEMAINTENANCEREQUEST._serialized_end=4419
  _RESCHEDULEMAINTENANCEREQUEST_RESCHEDULETYPE._serialized_start=4309
  _RESCHEDULEMAINTENANCEREQUEST_RESCHEDULETYPE._serialized_end=4419
  _RESCHEDULEMAINTENANCEMETADATA._serialized_start=4421
  _RESCHEDULEMAINTENANCEMETADATA._serialized_end=4523
  _CLUSTERSERVICE._serialized_start=4526
  _CLUSTERSERVICE._serialized_end=6863
