...
DESCRIPTOR = _descriptor_pool.Default().AddSerializedFile(b'\n-yandex/cloud/mdb/mongodb/v1/maintenance.proto\x12\x1byandex.cloud.mdb.mongodb.v1\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x1dyandex/cloud/validation.proto\"\xc8\x01\n\x11MaintenanceWindow\x12H\n\x07\x61nytime\x18\x01 \x01(\x0b\x32\x35.yandex.cloud.mdb.mongodb.v1.AnytimeMaintenanceWindowH\x00\x12Y\n\x19weekly_maintenance_window\x18\x02 \x01(\x0b\x32\x34.yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindowH\x00\x42\x0e\n\x06policy\x12\x04\xc0\xc1\x31\x01\"\x1a\n\x18\x41nytimeMaintenanceWindow\"\xe0\x01\n\x17WeeklyMaintenanceWindow\x12I\n\x03\x64\x61y\x18\x01 \x01(\x0e\x32<.yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindow.WeekDay\x12\x16\n\x04hour\x18\x02 \x01(\x03\x42\x08\xfa\xc7\x31\x04\x31-24\"b\n\x07WeekDay\x12\x18\n\x14WEEK_DAY_UNSPECIFIED\x10\x00\x12\x07\n\x03MON\x10\x01\x12\x07\n\x03TUE\x10\x02\x12\x07\n\x03WED\x10\x03\x12\x07\n\x03THU\x10\x04\x12\x07\n\x03\x46RI\x10\x05\x12\x07\n\x03SAT\x10\x06\x12\x07\n\x03SUN\x10\x07\"b\n\x14MaintenanceOperation\x12\x17\n\x04info\x18\x01 \x01(\tB\t\x8a\xc8\x31\x05<=256\x12\x31\n\rdelayed_until\x18\x02 \x01(\x0b\x32\x1a.google.protobuf.TimestampBj\n\x1fyandex.cloud.api.mdb.mongodb.v1ZGgithub.com/yandex-cloud/go-genproto/yandex/cloud/mdb/mongodb/v1;mongodbb\x06proto3')
...
MaintenanceWindow = _reflection.GeneratedProtocolMessageType('MaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mongodb.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mongodb.v1.MaintenanceWindow)
  })
...
AnytimeMaintenanceWindow = _reflection.GeneratedProtocolMessageType('AnytimeMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mongodb.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mongodb.v1.AnytimeMaintenanceWindow)
  })
...
WeeklyMaintenanceWindow = _reflection.GeneratedProtocolMessageType('WeeklyMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mongodb.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mongodb.v1.WeeklyMaintenanceWindow)
  })
...
MaintenanceOperation = _reflection.GeneratedProtocolMessageType('MaintenanceOperation', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mongodb.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mongodb.v1.MaintenanceOperation)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MAINTENANCEWINDOW._serialized_start=143
  _MAINTENANCEWINDOW._serialized_end=343
  _ANYTIMEMAINTENANCEWINDOW._serialized_start=345
  _ANYTIMEMAINTENANCEWINDOW._serialized_end=371
  _WEEKLYMAINTENANCEWINDOW._serialized_start=374
  _WEEKLYMAINTENANCEWINDOW._serialized_end=598
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_start=500
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_end=598
  _MAINTENANCEOPERATION._serialized_start=600
  _MAINTENANCEOPERATION._serialized_end=698
