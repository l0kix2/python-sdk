...
GetResourcePresetRequest = _reflection.GeneratedProtocolMessageType('GetResourcePresetRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mysql.v1alpha.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mysql.v1alpha.GetResourcePresetRequest)
  })
...
ListResourcePresetsRequest = _reflection.GeneratedProtocolMessageType('ListResourcePresetsRequest', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mysql.v1alpha.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsRequest)
  })
...
ListResourcePresetsResponse = _reflection.GeneratedProtocolMessageType('ListResourcePresetsResponse', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.mysql.v1alpha.resource_preset_service_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.mysql.v1alpha.ListResourcePresetsResponse)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _RESOURCEPRESETSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002=\022;/managed-mysql/v1alpha/resourcePresets/{resource_preset_id}'
  _RESOURCEPRESETSERVICE.methods_by_name['List']._options = None
  _RESOURCEPRESETSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002(\022&/managed-mysql/v1alpha/resourcePresets'
  _GETRESOURCEPRESETREQUEST._serialized_start=211
  _GETRESOURCEPRESETREQUEST._serialized_end=271
  _LISTRESOURCEPRESETSREQUEST._serialized_start=273
  _LISTRESOURCEPRESETSREQUEST._serialized_end=363
  _LISTRESOURCEPRESETSRESPONSE._serialized_start=366
  _LISTRESOURCEPRESETSRESPONSE._serialized_end=505
  _RESOURCEPRESETSERVICE._serialized_start=508
  _RESOURCEPRESETSERVICE._serialized_end=892
