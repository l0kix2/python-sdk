...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _USERSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002@\022>/managed-mysql/v1alpha/clusters/{cluster_id}/users/{user_name}'
  _USERSERVICE.methods_by_name['List']._options = None
  _USERSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\0024\0222/managed-mysql/v1alpha/clusters/{cluster_id}/users'
  _USERSERVICE.methods_by_name['Create']._options = None
  _USERSERVICE.methods_by_name['Create']._serialized_options = b'\202\323\344\223\0027\"2/managed-mysql/v1alpha/clusters/{cluster_id}/users:\001*\262\322*\032\n\022CreateUserMetadata\022\004User'
  _USERSERVICE.methods_by_name['Update']._options = None
  _USERSERVICE.methods_by_name['Update']._serialized_options = b'\202\323\344\223\002C2>/managed-mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:\001*\262\322*\032\n\022UpdateUserMetadata\022\004User'
  _USERSERVICE.methods_by_name['Delete']._options = None
  _USERSERVICE.methods_by_name['Delete']._serialized_options = b'\202\323\344\223\002@*>/managed-mysql/v1alpha/clusters/{cluster_id}/users/{user_name}\262\322*+\n\022DeleteUserMetadata\022\025google.protobuf.Empty'
  _USERSERVICE.methods_by_name['GrantPermission']._options = None
  _USERSERVICE.methods_by_name['GrantPermission']._serialized_options = b'\202\323\344\223\002S\"N/managed-mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:grantPermission:\001*\262\322*#\n\033GrantUserPermissionMetadata\022\004User'
  _USERSERVICE.methods_by_name['RevokePermission']._options = None
  _USERSERVICE.methods_by_name['RevokePermission']._serialized_options = b'\202\323\344\223\002T\"O/managed-mysql/v1alpha/clusters/{cluster_id}/users/{user_name}:revokePermission:\001*\262\322*$\n\034RevokeUserPermissionMetadata\022\004User'
  ...
  _UPDATEUSERREQUEST._serialized_end=1044
  _UPDATEUSERMETADATA._serialized_start=1046
  _UPDATEUSERMETADATA._serialized_end=1105
  _DELETEUSERREQUEST._serialized_start=1107
  _DELETEUSERREQUEST._serialized_end=1210
  _DELETEUSERMETADATA._serialized_start=1212
  _DELETEUSERMETADATA._serialized_end=1271
  _GRANTUSERPERMISSIONREQUEST._serialized_start=1274
  _GRANTUSERPERMISSIONREQUEST._serialized_end=1456
  _GRANTUSERPERMISSIONMETADATA._serialized_start=1458
  _GRANTUSERPERMISSIONMETADATA._serialized_end=1526
  _REVOKEUSERPERMISSIONREQUEST._serialized_start=1529
  _REVOKEUSERPERMISSIONREQUEST._serialized_end=1697
  _REVOKEUSERPERMISSIONMETADATA._serialized_start=1699
  _REVOKEUSERPERMISSIONMETADATA._serialized_end=1768
  _USERSERVICE._serialized_start=1771
  _USERSERVICE._serialized_end=3224
