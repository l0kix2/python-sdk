...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _POSTGRESQLCONFIG10.fields_by_name['bgwriter_delay']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['bgwriter_delay']._serialized_options = b'\372\3071\01010-10000'
  _POSTGRESQLCONFIG10.fields_by_name['bgwriter_flush_after']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['bgwriter_flush_after']._serialized_options = b'\372\3071\0060-2048'
  _POSTGRESQLCONFIG10.fields_by_name['backend_flush_after']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['backend_flush_after']._serialized_options = b'\372\3071\0060-2048'
  _POSTGRESQLCONFIG10.fields_by_name['old_snapshot_threshold']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['old_snapshot_threshold']._serialized_options = b'\372\3071\013-1-86400000'
  _POSTGRESQLCONFIG10.fields_by_name['checkpoint_timeout']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['checkpoint_timeout']._serialized_options = b'\372\3071\01630000-86400000'
  _POSTGRESQLCONFIG10.fields_by_name['checkpoint_flush_after']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['checkpoint_flush_after']._serialized_options = b'\372\3071\0060-2048'
  _POSTGRESQLCONFIG10.fields_by_name['from_collapse_limit']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['from_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _POSTGRESQLCONFIG10.fields_by_name['join_collapse_limit']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['join_collapse_limit']._serialized_options = b'\372\3071\0141-2147483647'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_max_workers']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_max_workers']._serialized_options = b'\372\3071\0041-32'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_cost_delay']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_cost_delay']._serialized_options = b'\372\3071\006-1-100'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_cost_limit']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_cost_limit']._serialized_options = b'\372\3071\010-1-10000'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_naptime']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_naptime']._serialized_options = b'\372\3071\r1000-86400000'
  _POSTGRESQLCONFIG10.fields_by_name['archive_timeout']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['archive_timeout']._serialized_options = b'\372\3071\01610000-86400000'
  _POSTGRESQLCONFIG10.fields_by_name['track_activity_query_size']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['track_activity_query_size']._serialized_options = b'\372\3071\n100-102400'
  _POSTGRESQLCONFIG10.fields_by_name['max_worker_processes']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['max_worker_processes']._serialized_options = b'\372\3071\0060-1024'
  _POSTGRESQLCONFIG10.fields_by_name['max_parallel_workers']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['max_parallel_workers']._serialized_options = b'\372\3071\0060-1024'
  _POSTGRESQLCONFIG10.fields_by_name['max_parallel_workers_per_gather']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['max_parallel_workers_per_gather']._serialized_options = b'\372\3071\0060-1024'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_scale_factor']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_vacuum_scale_factor']._serialized_options = b'\372\3071\0070.0-1.0'
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_analyze_scale_factor']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['autovacuum_analyze_scale_factor']._serialized_options = b'\372\3071\0070.0-1.0'
  _POSTGRESQLCONFIG10.fields_by_name['effective_io_concurrency']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['effective_io_concurrency']._serialized_options = b'\372\3071\0060-1000'
  _POSTGRESQLCONFIG10.fields_by_name['effective_cache_size']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['effective_cache_size']._serialized_options = b'\372\3071\0160-549755813888'
  _POSTGRESQLCONFIG10.fields_by_name['auto_explain_log_min_duration']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['auto_explain_log_min_duration']._serialized_options = b'\372\3071\r-1-2147483647'
  _POSTGRESQLCONFIG10.fields_by_name['auto_explain_sample_rate']._options = None
  _POSTGRESQLCONFIG10.fields_by_name['auto_explain_sample_rate']._serialized_options = b'\372\3071\0070.0-1.0'
  _POSTGRESQLCONFIGSET10.fields_by_name['effective_config']._options = None
  _POSTGRESQLCONFIGSET10.fields_by_name['effective_config']._serialized_options = b'\350\3071\001'
  _POSTGRESQLCONFIG10._serialized_start=163
  _POSTGRESQLCONFIG10._serialized_end=9982
  _POSTGRESQLCONFIG10_WALLEVEL._serialized_start=7694
  _POSTGRESQLCONFIG10_WALLEVEL._serialized_end=7777
  _POSTGRESQLCONFIG10_SYNCHRONOUSCOMMIT._serialized_start=7780
  _POSTGRESQLCONFIG10_SYNCHRONOUSCOMMIT._serialized_end=7994
  _POSTGRESQLCONFIG10_CONSTRAINTEXCLUSION._serialized_start=7997
  _POSTGRESQLCONFIG10_CONSTRAINTEXCLUSION._serialized_end=8151
  _POSTGRESQLCONFIG10_FORCEPARALLELMODE._serialized_start=8154
  _POSTGRESQLCONFIG10_FORCEPARALLELMODE._serialized_end=8300
  _POSTGRESQLCONFIG10_LOGLEVEL._serialized_start=8303
  _POSTGRESQLCONFIG10_LOGLEVEL._serialized_end=8577
  _POSTGRESQLCONFIG10_LOGERRORVERBOSITY._serialized_start=8580
  _POSTGRESQLCONFIG10_LOGERRORVERBOSITY._serialized_end=8733
  _POSTGRESQLCONFIG10_LOGSTATEMENT._serialized_start=8736
  _POSTGRESQLCONFIG10_LOGSTATEMENT._serialized_end=8874
  _POSTGRESQLCONFIG10_TRANSACTIONISOLATION._serialized_start=8877
  _POSTGRESQLCONFIG10_TRANSACTIONISOLATION._serialized_end=9107
  _POSTGRESQLCONFIG10_BYTEAOUTPUT._serialized_start=9109
  _POSTGRESQLCONFIG10_BYTEAOUTPUT._serialized_end=9200
  _POSTGRESQLCONFIG10_XMLBINARY._serialized_start=9202
  _POSTGRESQLCONFIG10_XMLBINARY._serialized_end=9284
  _POSTGRESQLCONFIG10_XMLOPTION._serialized_start=9286
  _POSTGRESQLCONFIG10_XMLOPTION._serialized_end=9374
  _POSTGRESQLCONFIG10_BACKSLASHQUOTE._serialized_start=9377
  _POSTGRESQLCONFIG10_BACKSLASHQUOTE._serialized_end=9531
  _POSTGRESQLCONFIG10_PGHINTPLANDEBUGPRINT._serialized_start=9534
  _POSTGRESQLCONFIG10_PGHINTPLANDEBUGPRINT._serialized_end=9742
  _POSTGRESQLCONFIG10_SHAREDPRELOADLIBRARIES._serialized_start=9745
  _POSTGRESQLCONFIG10_SHAREDPRELOADLIBRARIES._serialized_end=9982
  _POSTGRESQLCONFIGSET10._serialized_start=9985
  _POSTGRESQLCONFIGSET10._serialized_end=10262
