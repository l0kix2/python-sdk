...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _UPDATEUSERREQUEST.fields_by_name['conn_limit']._serialized_options = b'\372\3071\004>=10'
  _UPDATEUSERREQUEST.fields_by_name['grants']._options = None
  _UPDATEUSERREQUEST.fields_by_name['grants']._serialized_options = b'\212\3101\004<=63\362\3071\r[a-zA-Z0-9_]*'
  ...
  _USERSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002@\022>/managed-postgresql/v1/clusters/{cluster_id}/users/{user_name}'
  _USERSERVICE.methods_by_name['List']._options = None
  _USERSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\0024\0222/managed-postgresql/v1/clusters/{cluster_id}/users'
  _USERSERVICE.methods_by_name['Create']._options = None
  _USERSERVICE.methods_by_name['Create']._serialized_options = b'\202\323\344\223\0027\"2/managed-postgresql/v1/clusters/{cluster_id}/users:\001*\262\322*\032\n\022CreateUserMetadata\022\004User'
  _USERSERVICE.methods_by_name['Update']._options = None
  _USERSERVICE.methods_by_name['Update']._serialized_options = b'\202\323\344\223\002C2>/managed-postgresql/v1/clusters/{cluster_id}/users/{user_name}:\001*\262\322*\032\n\022UpdateUserMetadata\022\004User'
  _USERSERVICE.methods_by_name['Delete']._options = None
  _USERSERVICE.methods_by_name['Delete']._serialized_options = b'\202\323\344\223\002@*>/managed-postgresql/v1/clusters/{cluster_id}/users/{user_name}\262\322*+\n\022DeleteUserMetadata\022\025google.protobuf.Empty'
  _USERSERVICE.methods_by_name['GrantPermission']._options = None
  _USERSERVICE.methods_by_name['GrantPermission']._serialized_options = b'\202\323\344\223\002S\"N/managed-postgresql/v1/clusters/{cluster_id}/users/{user_name}:grantPermission:\001*\262\322*#\n\033GrantUserPermissionMetadata\022\004User'
  _USERSERVICE.methods_by_name['RevokePermission']._options = None
  _USERSERVICE.methods_by_name['RevokePermission']._serialized_options = b'\202\323\344\223\002T\"O/managed-postgresql/v1/clusters/{cluster_id}/users/{user_name}:revokePermission:\001*\262\322*$\n\034RevokeUserPermissionMetadata\022\004User'
  _GETUSERREQUEST._serialized_start=329
  _GETUSERREQUEST._serialized_end=429
  _LISTUSERSREQUEST._serialized_start=431
  _LISTUSERSREQUEST._serialized_end=545
  _LISTUSERSRESPONSE._serialized_start=547
  _LISTUSERSRESPONSE._serialized_end=644
  _CREATEUSERREQUEST._serialized_start=646
  _CREATEUSERREQUEST._serialized_end=766
  _CREATEUSERMETADATA._serialized_start=768
  _CREATEUSERMETADATA._serialized_end=827
  _UPDATEUSERREQUEST._serialized_start=830
  _UPDATEUSERREQUEST._serialized_end=1256
  _UPDATEUSERMETADATA._serialized_start=1258
  _UPDATEUSERMETADATA._serialized_end=1317
  _DELETEUSERREQUEST._serialized_start=1319
  _DELETEUSERREQUEST._serialized_end=1422
  _DELETEUSERMETADATA._serialized_start=1424
  _DELETEUSERMETADATA._serialized_end=1483
  _GRANTUSERPERMISSIONREQUEST._serialized_start=1486
  _GRANTUSERPERMISSIONREQUEST._serialized_end=1668
  _GRANTUSERPERMISSIONMETADATA._serialized_start=1670
  _GRANTUSERPERMISSIONMETADATA._serialized_end=1738
  _REVOKEUSERPERMISSIONREQUEST._serialized_start=1741
  _REVOKEUSERPERMISSIONREQUEST._serialized_end=1909
  _REVOKEUSERPERMISSIONMETADATA._serialized_start=1911
  _REVOKEUSERPERMISSIONMETADATA._serialized_end=1980
  _USERSERVICE._serialized_start=1983
  _USERSERVICE._serialized_end=3436
