...
_REDISCONFIG5_0 = DESCRIPTOR.message_types_by_name['RedisConfig5_0']
_REDISCONFIGSET5_0 = DESCRIPTOR.message_types_by_name['RedisConfigSet5_0']
_REDISCONFIG5_0_MAXMEMORYPOLICY = _REDISCONFIG5_0.enum_types_by_name['MaxmemoryPolicy']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _REDISCONFIG5_0.fields_by_name['password']._serialized_options = b'\362\3071\"[a-zA-Z0-9@=+?*.,!&#$^<>_-]{8,128}'
  _REDISCONFIG5_0.fields_by_name['databases']._options = None
  _REDISCONFIG5_0.fields_by_name['databases']._serialized_options = b'\372\3071\002>0'
  _REDISCONFIG5_0.fields_by_name['slowlog_log_slower_than']._options = None
  _REDISCONFIG5_0.fields_by_name['slowlog_log_slower_than']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG5_0.fields_by_name['slowlog_max_len']._options = None
  _REDISCONFIG5_0.fields_by_name['slowlog_max_len']._serialized_options = b'\372\3071\003>=0'
  _REDISCONFIG5_0.fields_by_name['notify_keyspace_events']._options = None
  _REDISCONFIG5_0.fields_by_name['notify_keyspace_events']._serialized_options = b'\362\3071\024[KEg$lshzxeAt]{0,12}'
  _REDISCONFIG5_0._serialized_start=149
  _REDISCONFIG5_0._serialized_end=808
  _REDISCONFIG5_0_MAXMEMORYPOLICY._serialized_start=612
  _REDISCONFIG5_0_MAXMEMORYPOLICY._serialized_end=808
  _REDISCONFIGSET5_0._serialized_start=811
  _REDISCONFIGSET5_0._serialized_end=1051
