...
MaintenanceWindow = _reflection.GeneratedProtocolMessageType('MaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.redis.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.redis.v1.MaintenanceWindow)
  })
...
AnytimeMaintenanceWindow = _reflection.GeneratedProtocolMessageType('AnytimeMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.redis.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.redis.v1.AnytimeMaintenanceWindow)
  })
...
WeeklyMaintenanceWindow = _reflection.GeneratedProtocolMessageType('WeeklyMaintenanceWindow', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.redis.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.redis.v1.WeeklyMaintenanceWindow)
  })
...
MaintenanceOperation = _reflection.GeneratedProtocolMessageType('MaintenanceOperation', (_message.Message,), {
  ...
  '__module__' : 'yandex.cloud.mdb.redis.v1.maintenance_pb2'
  # @@protoc_insertion_point(class_scope:yandex.cloud.mdb.redis.v1.MaintenanceOperation)
  })
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _MAINTENANCEWINDOW._serialized_start=139
  _MAINTENANCEWINDOW._serialized_end=335
  _ANYTIMEMAINTENANCEWINDOW._serialized_start=337
  _ANYTIMEMAINTENANCEWINDOW._serialized_end=363
  _WEEKLYMAINTENANCEWINDOW._serialized_start=366
  _WEEKLYMAINTENANCEWINDOW._serialized_end=588
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_start=490
  _WEEKLYMAINTENANCEWINDOW_WEEKDAY._serialized_end=588
  _MAINTENANCEOPERATION._serialized_start=590
  _MAINTENANCEOPERATION._serialized_end=688
