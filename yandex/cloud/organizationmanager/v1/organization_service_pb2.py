...
_UPDATEORGANIZATIONREQUEST_LABELSENTRY = _UPDATEORGANIZATIONREQUEST.nested_types_by_name['LabelsEntry']
_UPDATEORGANIZATIONMETADATA = DESCRIPTOR.message_types_by_name['UpdateOrganizationMetadata']
_LISTORGANIZATIONOPERATIONSREQUEST = DESCRIPTOR.message_types_by_name['ListOrganizationOperationsRequest']
_LISTORGANIZATIONOPERATIONSRESPONSE = DESCRIPTOR.message_types_by_name['ListOrganizationOperationsResponse']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETORGANIZATIONREQUEST.fields_by_name['organization_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTORGANIZATIONSREQUEST.fields_by_name['page_size']._options = None
  _LISTORGANIZATIONSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTORGANIZATIONSREQUEST.fields_by_name['page_token']._options = None
  _LISTORGANIZATIONSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _LISTORGANIZATIONSREQUEST.fields_by_name['filter']._options = None
  _LISTORGANIZATIONSREQUEST.fields_by_name['filter']._serialized_options = b'\212\3101\006<=1000'
  _UPDATEORGANIZATIONREQUEST_LABELSENTRY._options = None
  _UPDATEORGANIZATIONREQUEST_LABELSENTRY._serialized_options = b'8\001'
  _UPDATEORGANIZATIONREQUEST.fields_by_name['organization_id']._options = None
  _UPDATEORGANIZATIONREQUEST.fields_by_name['organization_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _UPDATEORGANIZATIONREQUEST.fields_by_name['name']._options = None
  _UPDATEORGANIZATIONREQUEST.fields_by_name['name']._serialized_options = b'\362\3071 |[a-z]([-a-z0-9]{0,61}[a-z0-9])?'
  _UPDATEORGANIZATIONREQUEST.fields_by_name['description']._options = None
  _UPDATEORGANIZATIONREQUEST.fields_by_name['description']._serialized_options = b'\212\3101\005<=256'
  _UPDATEORGANIZATIONREQUEST.fields_by_name['title']._options = None
  _UPDATEORGANIZATIONREQUEST.fields_by_name['title']._serialized_options = b'\212\3101\005<=256'
  _UPDATEORGANIZATIONREQUEST.fields_by_name['labels']._options = None
  _UPDATEORGANIZATIONREQUEST.fields_by_name['labels']._serialized_options = b'\202\3101\004<=64\212\3101\004<=63\362\3071\013[-_0-9a-z]*\262\3101\006\032\0041-63\262\3101\022\022\020[a-z][-_0-9a-z]*'
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['organization_id']._options = None
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['organization_id']._serialized_options = b'\350\3071\001\212\3101\004<=50'
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['page_size']._options = None
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['page_token']._options = None
  _LISTORGANIZATIONOPERATIONSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _ORGANIZATIONSERVICE.methods_by_name['Get']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002:\0228/organization-manager/v1/organizations/{organization_id}'
  _ORGANIZATIONSERVICE.methods_by_name['List']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002(\022&/organization-manager/v1/organizations'
  _ORGANIZATIONSERVICE.methods_by_name['Update']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['Update']._serialized_options = b'\202\323\344\223\002=28/organization-manager/v1/organizations/{organization_id}:\001*\262\322**\n\032UpdateOrganizationMetadata\022\014Organization'
  _ORGANIZATIONSERVICE.methods_by_name['ListOperations']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['ListOperations']._serialized_options = b'\202\323\344\223\002E\022C/organization-manager/v1/organizations/{organization_id}/operations'
  _ORGANIZATIONSERVICE.methods_by_name['ListAccessBindings']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['ListAccessBindings']._serialized_options = b'\202\323\344\223\002I\022G/organization-manager/v1/organizations/{resource_id}:listAccessBindings'
  _ORGANIZATIONSERVICE.methods_by_name['SetAccessBindings']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['SetAccessBindings']._serialized_options = b'\202\323\344\223\002K\"F/organization-manager/v1/organizations/{resource_id}:setAccessBindings:\001*\262\322*9\n access.SetAccessBindingsMetadata\022\025google.protobuf.Empty'
  _ORGANIZATIONSERVICE.methods_by_name['UpdateAccessBindings']._options = None
  _ORGANIZATIONSERVICE.methods_by_name['UpdateAccessBindings']._serialized_options = b'\202\323\344\223\002N\"I/organization-manager/v1/organizations/{resource_id}:updateAccessBindings:\001*\262\322*<\n#access.UpdateAccessBindingsMetadata\022\025google.protobuf.Empty'
  _GETORGANIZATIONREQUEST._serialized_start=362
  _GETORGANIZATIONREQUEST._serialized_end=425
  _LISTORGANIZATIONSREQUEST._serialized_start=427
  _LISTORGANIZATIONSREQUEST._serialized_end=543
  _LISTORGANIZATIONSRESPONSE._serialized_start=545
  _LISTORGANIZATIONSRESPONSE._serialized_end=671
  _UPDATEORGANIZATIONREQUEST._serialized_start=674
  _UPDATEORGANIZATIONREQUEST._serialized_end=1104
  _UPDATEORGANIZATIONREQUEST_LABELSENTRY._serialized_start=1059
  _UPDATEORGANIZATIONREQUEST_LABELSENTRY._serialized_end=1104
  _UPDATEORGANIZATIONMETADATA._serialized_start=1106
  _UPDATEORGANIZATIONMETADATA._serialized_end=1159
  _LISTORGANIZATIONOPERATIONSREQUEST._serialized_start=1162
  _LISTORGANIZATIONOPERATIONSREQUEST._serialized_end=1298
  _LISTORGANIZATIONOPERATIONSRESPONSE._serialized_start=1300
  _LISTORGANIZATIONOPERATIONSRESPONSE._serialized_end=1416
  _ORGANIZATIONSERVICE._serialized_start=1419
  _ORGANIZATIONSERVICE._serialized_end=2987
