...
_BACKUPSCHEDULE = DESCRIPTOR.message_types_by_name['BackupSchedule']
_RECURRINGBACKUPSCHEDULE = DESCRIPTOR.message_types_by_name['RecurringBackupSchedule']
_DAYSOFWEEKBACKUPSCHEDULE = DESCRIPTOR.message_types_by_name['DaysOfWeekBackupSchedule']
_WEEKLYBACKUPSCHEDULE = DESCRIPTOR.message_types_by_name['WeeklyBackupSchedule']
_DAILYBACKUPSCHEDULE = DESCRIPTOR.message_types_by_name['DailyBackupSchedule']
_BACKUPSETTINGS = DESCRIPTOR.message_types_by_name['BackupSettings']
_BACKUPCONFIG = DESCRIPTOR.message_types_by_name['BackupConfig']
_BACKUP = DESCRIPTOR.message_types_by_name['Backup']
_BACKUPSETTINGS_TYPE = _BACKUPSETTINGS.enum_types_by_name['Type']
_BACKUPSETTINGS_STORAGECLASS = _BACKUPSETTINGS.enum_types_by_name['StorageClass']
_BACKUP_STATUS = _BACKUP.enum_types_by_name['Status']
_BACKUP_TYPE = _BACKUP.enum_types_by_name['Type']
...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _BACKUPSCHEDULE.oneofs_by_name['policy']._serialized_options = b'\300\3011\001'
  _RECURRINGBACKUPSCHEDULE.fields_by_name['start_time']._options = None
  _RECURRINGBACKUPSCHEDULE.fields_by_name['start_time']._serialized_options = b'\350\3071\001'
  _RECURRINGBACKUPSCHEDULE.fields_by_name['recurrence']._options = None
  _RECURRINGBACKUPSCHEDULE.fields_by_name['recurrence']._serialized_options = b'\350\3071\001'
  _DAYSOFWEEKBACKUPSCHEDULE.fields_by_name['days']._options = None
  _DAYSOFWEEKBACKUPSCHEDULE.fields_by_name['days']._serialized_options = b'\202\3101\0031-7'
  _DAYSOFWEEKBACKUPSCHEDULE.fields_by_name['execute_time']._options = None
  _DAYSOFWEEKBACKUPSCHEDULE.fields_by_name['execute_time']._serialized_options = b'\350\3071\001'
  _WEEKLYBACKUPSCHEDULE.fields_by_name['days_of_week']._options = None
  _WEEKLYBACKUPSCHEDULE.fields_by_name['days_of_week']._serialized_options = b'\202\3101\0031-7'
  _DAILYBACKUPSCHEDULE.fields_by_name['execute_time']._options = None
  _DAILYBACKUPSCHEDULE.fields_by_name['execute_time']._serialized_options = b'\350\3071\001'
  _BACKUPSETTINGS.fields_by_name['name']._options = None
  _BACKUPSETTINGS.fields_by_name['name']._serialized_options = b'\212\3101\005<=256'
  _BACKUPSETTINGS.fields_by_name['description']._options = None
  _BACKUPSETTINGS.fields_by_name['description']._serialized_options = b'\212\3101\005<=256'
  _BACKUPSETTINGS.fields_by_name['source_paths']._options = None
  _BACKUPSETTINGS.fields_by_name['source_paths']._serialized_options = b'\202\3101\005<=256'
  _BACKUPSETTINGS.fields_by_name['source_paths_to_exclude']._options = None
  _BACKUPSETTINGS.fields_by_name['source_paths_to_exclude']._serialized_options = b'\202\3101\005<=256'
  _BACKUPSCHEDULE._serialized_start=212
  _BACKUPSCHEDULE._serialized_end=534
  _RECURRINGBACKUPSCHEDULE._serialized_start=536
  _RECURRINGBACKUPSCHEDULE._serialized_end=641
  _DAYSOFWEEKBACKUPSCHEDULE._serialized_start=643
  _DAYSOFWEEKBACKUPSCHEDULE._serialized_end=768
  _WEEKLYBACKUPSCHEDULE._serialized_start=770
  _WEEKLYBACKUPSCHEDULE._serialized_end=870
  _DAILYBACKUPSCHEDULE._serialized_start=872
  _DAILYBACKUPSCHEDULE._serialized_end=945
  _BACKUPSETTINGS._serialized_start=948
  _BACKUPSETTINGS._serialized_end=1586
  _BACKUPSETTINGS_TYPE._serialized_start=1347
  _BACKUPSETTINGS_TYPE._serialized_end=1397
  _BACKUPSETTINGS_STORAGECLASS._serialized_start=1400
  _BACKUPSETTINGS_STORAGECLASS._serialized_end=1586
  _BACKUPCONFIG._serialized_start=1588
  _BACKUPCONFIG._serialized_end=1664
  _BACKUP._serialized_start=1667
  _BACKUP._serialized_end=2221
  _BACKUP_STATUS._serialized_start=2086
  _BACKUP_STATUS._serialized_end=2169
  _BACKUP_TYPE._serialized_start=1347
  _BACKUP_TYPE._serialized_end=1397
