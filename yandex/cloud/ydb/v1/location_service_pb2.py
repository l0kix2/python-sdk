...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _GETLOCATIONREQUEST.fields_by_name['location_id']._serialized_options = b'\350\3071\001'
  _LISTLOCATIONSREQUEST.fields_by_name['page_size']._options = None
  _LISTLOCATIONSREQUEST.fields_by_name['page_size']._serialized_options = b'\372\3071\0060-1000'
  _LISTLOCATIONSREQUEST.fields_by_name['page_token']._options = None
  _LISTLOCATIONSREQUEST.fields_by_name['page_token']._serialized_options = b'\212\3101\005<=100'
  _LOCATIONSERVICE.methods_by_name['Get']._options = None
  _LOCATIONSERVICE.methods_by_name['Get']._serialized_options = b'\202\323\344\223\002!\022\037/ydb/v1/locations/{location_id}'
  _LOCATIONSERVICE.methods_by_name['List']._options = None
  _LOCATIONSERVICE.methods_by_name['List']._serialized_options = b'\202\323\344\223\002\023\022\021/ydb/v1/locations'
  _GETLOCATIONREQUEST._serialized_start=164
  _GETLOCATIONREQUEST._serialized_end=211
  _LISTLOCATIONSREQUEST._serialized_start=213
  _LISTLOCATIONSREQUEST._serialized_end=297
  _LISTLOCATIONSRESPONSE._serialized_start=299
  _LISTLOCATIONSRESPONSE._serialized_end=397
  _LOCATIONSERVICE._serialized_start=400
  _LOCATIONSERVICE._serialized_end=659
